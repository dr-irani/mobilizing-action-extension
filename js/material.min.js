...
!(function () {
  ...
  function e (e, t) {
    if (e) {
      if (t.element_.classList.contains (t.CssClasses_.MDL_JS_RIPPLE_EFFECT)) {
        ...
        s.classList.add (t.CssClasses_.MDL_RIPPLE_CONTAINER), s.classList.add (
          t.CssClasses_.MDL_JS_RIPPLE_EFFECT
        );
        var i = document.createElement ('span');
        i.classList.add (t.CssClasses_.MDL_RIPPLE), s.appendChild (
          i
        ), e.appendChild (s);
      }
  ...
  function t (e, t, s, i) {
    function n () {
      ...
      i.resetTabState_ (t), i.resetPanelState_ (s), e.classList.add (
        i.CssClasses_.IS_ACTIVE
      ), a.classList.add (i.CssClasses_.IS_ACTIVE);
    }
    if (i.tabBar_.classList.contains (i.CssClasses_.JS_RIPPLE_EFFECT)) {
      var a = document.createElement ('span');
      a.classList.add (i.CssClasses_.RIPPLE_CONTAINER), a.classList.add (
        i.CssClasses_.JS_RIPPLE_EFFECT
      );
      var l = document.createElement ('span');
      l.classList.add (i.CssClasses_.RIPPLE), a.appendChild (l), e.appendChild (
        a
      );
    }
  ...
  (s = (function () {
    ...
    function n (i, n) {
      ...
      for (var r, _ = 0, d = l.length; d > _; _++) {
        ...
        'CustomEvent' in window && 'function' == typeof window.CustomEvent
          ? (m = new Event ('mdl-componentupgraded', {
              bubbles: !0,
              cancelable: !1,
            }))
          : ((m = document.createEvent ('Events')), m.initEvent (
    ...
    function a (e) {
      Array.isArray (e) ||
        (e = 'function' == typeof e.item
          ? Array.prototype.slice.call (e)
          : [e]);
      for (var t, s = 0, i = e.length; i > s; s++)
        (t = e[s]), t instanceof HTMLElement &&
    ...
    function _ (e) {
      if (e) {
        ...
        s.splice (i, 1), e.element_.setAttribute (
          'data-upgraded',
          s.join (',')
        );
        var n;
        'CustomEvent' in window && 'function' == typeof window.CustomEvent
          ? (n = new Event ('mdl-componentdowngraded', {
              bubbles: !0,
              cancelable: !1,
            }))
          : ((n = document.createEvent ('Events')), n.initEvent (
  ...
  }) ()), s.ComponentConfigPublic, s.ComponentConfig, s.Component, (s.upgradeDom =
    s.upgradeDom), (s.upgradeElement = s.upgradeElement), (s.upgradeElements =
    s.upgradeElements), (s.upgradeAllRegistered =
    s.upgradeAllRegistered), (s.registerUpgradedCallback =
    s.registerUpgradedCallback), (s.register =
    s.register), (s.downgradeElements =
    s.downgradeElements), (window.componentHandler = s), (window.componentHandler = s), window.addEventListener (
    'load',
    function () {
  ...
  for (
    ...
    (window.requestAnimationFrame =
      window[a + 'RequestAnimationFrame']), (window.cancelAnimationFrame =
  ...
  (window.MaterialButton = o), (o.prototype.Constant_ = {}), (o.prototype.CssClasses_ = {
    ...
    o.prototype.disable), (o.prototype.enable = function () {
    this.element_.disabled = !1;
  }), (o.prototype.enable =
    o.prototype.enable), (o.prototype.init = function () {
    if (this.element_) {
      if (this.element_.classList.contains (this.CssClasses_.RIPPLE_EFFECT)) {
        var e = document.createElement ('span');
        e.classList.add (
          this.CssClasses_.RIPPLE_CONTAINER
        ), (this.rippleElement_ = document.createElement (
          'span'
      ...
      (this.boundButtonBlurHandler = this.blurHandler_.bind (
        this
  ...
  (window.MaterialCheckbox = r), (r.prototype.Constant_ = {
    ...
    r.prototype.checkToggleState), (r.prototype.checkDisabled = function () {
    this.inputElement_.disabled
      ? this.element_.classList.add (this.CssClasses_.IS_DISABLED)
      : this.element_.classList.remove (this.CssClasses_.IS_DISABLED);
  }), (r.prototype.checkDisabled =
    r.prototype.checkDisabled), (r.prototype.disable = function () {
    (this.inputElement_.disabled = !0), this.updateClasses_ ();
  }), (r.prototype.disable =
    r.prototype.disable), (r.prototype.enable = function () {
    (this.inputElement_.disabled = !1), this.updateClasses_ ();
  }), (r.prototype.enable =
    r.prototype.enable), (r.prototype.check = function () {
    (this.inputElement_.checked = !0), this.updateClasses_ ();
  }), (r.prototype.check =
    r.prototype.check), (r.prototype.uncheck = function () {
    (this.inputElement_.checked = !1), this.updateClasses_ ();
  }), (r.prototype.uncheck =
    r.prototype.uncheck), (r.prototype.init = function () {
    if (this.element_) {
      ...
      var s = document.createElement ('span');
      if (
        (s.classList.add (this.CssClasses_.TICK_OUTLINE), e.appendChild (
          s
        ), this.element_.appendChild (t), this.element_.appendChild (
          e
        ...
        ), (this.boundRippleMouseUp = this.onMouseUp_.bind (
          this
        ...
        i.classList.add (
          this.CssClasses_.RIPPLE
        ), this.rippleContainerElement_.appendChild (
          i
        ), this.element_.appendChild (this.rippleContainerElement_);
      }
      (this.boundInputOnChange = this.onChange_.bind (
        this
      )), (this.boundInputOnFocus = this.onFocus_.bind (
        this
      )), (this.boundInputOnBlur = this.onBlur_.bind (
        this
      )), (this.boundElementMouseUp = this.onMouseUp_.bind (
        this
      ...
      ), this.updateClasses_ (), this.element_.classList.add (
  ...
  (window.MaterialIconToggle = _), (_.prototype.Constant_ = {
    ...
    _.prototype.checkToggleState), (_.prototype.checkDisabled = function () {
    this.inputElement_.disabled
      ? this.element_.classList.add (this.CssClasses_.IS_DISABLED)
      : this.element_.classList.remove (this.CssClasses_.IS_DISABLED);
  }), (_.prototype.checkDisabled =
    _.prototype.checkDisabled), (_.prototype.disable = function () {
    (this.inputElement_.disabled = !0), this.updateClasses_ ();
  }), (_.prototype.disable =
    _.prototype.disable), (_.prototype.enable = function () {
    (this.inputElement_.disabled = !1), this.updateClasses_ ();
  }), (_.prototype.enable =
    _.prototype.enable), (_.prototype.check = function () {
    (this.inputElement_.checked = !0), this.updateClasses_ ();
  }), (_.prototype.check =
    _.prototype.check), (_.prototype.uncheck = function () {
    (this.inputElement_.checked = !1), this.updateClasses_ ();
  }), (_.prototype.uncheck =
    _.prototype.uncheck), (_.prototype.init = function () {
    if (this.element_) {
      if (
        ((this.inputElement_ = this.element_.querySelector (
          '.' + this.CssClasses_.INPUT
      ...
      (this.boundInputOnChange = this.onChange_.bind (
        ...
        this
      )), (this.boundElementOnMouseUp = this.onMouseUp_.bind (
        this
      )), this.inputElement_.addEventListener (
        'change',
        this.boundInputOnChange
  ...
  (window.MaterialMenu = d), (d.prototype.Constant_ = {
    ...
    if (this.element_) {
      ...
      s &&
        ((i = document.getElementById (s)), i &&
          ((this.forElement_ = i), i.addEventListener (
            'click',
      ...
      for (var a = 0; a < n.length; a++)
        n[a].addEventListener ('click', this.boundItemClick_), (n[a].tabIndex =
          '-1'), n[a].addEventListener ('keydown', this.boundItemKeydown_);
      if (this.element_.classList.contains (this.CssClasses_.RIPPLE_EFFECT))
        for (
          this.element_.classList.add (
            this.CssClasses_.RIPPLE_IGNORE_EVENTS
          ...
          r.classList.add (this.CssClasses_.RIPPLE), o.appendChild (
            r
          ), l.appendChild (o), l.classList.add (
            this.CssClasses_.RIPPLE_EFFECT
          );
        }
      ...
      this.element_.classList.contains (this.CssClasses_.UNALIGNED) ||
        (this.element_.classList.contains (this.CssClasses_.BOTTOM_RIGHT)
          ? ((this.container_.style.right =
              s.right - t.right + 'px'), (this.container_.style.top =
              this.forElement_.offsetTop +
              this.forElement_.offsetHeight +
              'px'))
          : this.element_.classList.contains (this.CssClasses_.TOP_LEFT)
              ? ((this.container_.style.left =
                  this.forElement_.offsetLeft +
                  'px'), (this.container_.style.bottom =
                  s.bottom - t.top + 'px'))
              : this.element_.classList.contains (this.CssClasses_.TOP_RIGHT)
                  ? ((this.container_.style.right =
                      s.right - t.right + 'px'), (this.container_.style.bottom =
                      s.bottom - t.top + 'px'))
                  : ((this.container_.style.left =
                      this.forElement_.offsetLeft +
                      'px'), (this.container_.style.top =
                      this.forElement_.offsetTop +
                      this.forElement_.offsetHeight +
                      'px')));
    }
    ...
    if (this.element_ && this.container_) {
      ...
      if (
        ...
        if (e.keyCode === this.Keycodes_.UP_ARROW)
          ...
          e.target.dispatchEvent (i), (i = new MouseEvent (
            'mouseup'
    ...
    e.target.hasAttribute ('disabled')
      ? e.stopPropagation ()
      : ((this.closing_ = !0), window.setTimeout (
          function (e) {
    ...
    if (this.element_ && this.container_ && this.outline_) {
      ...
      (this.container_.style.width = s + 'px'), (this.container_.style.height =
        t + 'px'), (this.outline_.style.width =
        s + 'px'), (this.outline_.style.height = t + 'px');
      for (
        var i =
        ...
        (l = this.element_.classList.contains (this.CssClasses_.TOP_LEFT) ||
          ...
          : n[a].offsetTop / t * i + 's'), (n[a].style.transitionDelay = l);
      }
      this.applyClip_ (t, s), window.requestAnimationFrame (
        function () {
          this.element_.classList.add (
            ...
            'px ' +
            t +
            'px 0)'), this.container_.classList.add (
  ...
  }), (d.prototype.hide = d.prototype.hide), (d.prototype.toggle = function (
    e
  ) {
    this.container_.classList.contains (this.CssClasses_.IS_VISIBLE)
      ? this.hide ()
  ...
  (window.MaterialProgress = h), (h.prototype.Constant_ = {}), (h.prototype.CssClasses_ = {
    ...
    h.prototype.setProgress), (h.prototype.setBuffer = function (e) {
    (this.bufferbar_.style.width = e + '%'), (this.auxbar_.style.width =
      100 - e + '%');
  }), (h.prototype.setBuffer =
    h.prototype.setBuffer), (h.prototype.init = function () {
    if (this.element_) {
      var e = document.createElement ('div');
      (e.className = 'progressbar bar bar1'), this.element_.appendChild (
        e
      ), (this.progressbar_ = e), (e = document.createElement (
        'div'
      )), (e.className = 'bufferbar bar bar2'), this.element_.appendChild (
        e
      ), (this.bufferbar_ = e), (e = document.createElement (
        'div'
      )), (e.className = 'auxbar bar bar3'), this.element_.appendChild (
        e
      ), (this.auxbar_ = e), (this.progressbar_.style.width =
        '0%'), (this.bufferbar_.style.width =
        '100%'), (this.auxbar_.style.width =
        '0%'), this.element_.classList.add ('is-upgraded');
    }
  }), s.register ({
    constructor: h,
  ...
  (window.MaterialRadio = c), (c.prototype.Constant_ = {
    ...
    c.prototype.checkDisabled), (c.prototype.checkToggleState = function () {
    this.btnElement_.checked
      ? this.element_.classList.add (this.CssClasses_.IS_CHECKED)
      : this.element_.classList.remove (this.CssClasses_.IS_CHECKED);
  }), (c.prototype.checkToggleState =
    c.prototype.checkToggleState), (c.prototype.disable = function () {
    (this.btnElement_.disabled = !0), this.updateClasses_ ();
  }), (c.prototype.disable =
    c.prototype.disable), (c.prototype.enable = function () {
    (this.btnElement_.disabled = !1), this.updateClasses_ ();
  }), (c.prototype.enable =
    c.prototype.enable), (c.prototype.check = function () {
    (this.btnElement_.checked = !0), this.updateClasses_ ();
  }), (c.prototype.check =
    c.prototype.check), (c.prototype.uncheck = function () {
    (this.btnElement_.checked = !1), this.updateClasses_ ();
  }), (c.prototype.uncheck =
    c.prototype.uncheck), (c.prototype.init = function () {
    if (this.element_) {
      (this.btnElement_ = this.element_.querySelector (
        '.' + this.CssClasses_.RADIO_BTN
      )), (this.boundChangeHandler_ = this.onChange_.bind (
        this
      )), (this.boundFocusHandler_ = this.onChange_.bind (
        this
      )), (this.boundBlurHandler_ = this.onBlur_.bind (
        this
      ...
      if (this.element_.classList.contains (this.CssClasses_.RIPPLE_EFFECT)) {
        this.element_.classList.add (
          this.CssClasses_.RIPPLE_IGNORE_EVENTS
        ), (s = document.createElement ('span')), s.classList.add (
          this.CssClasses_.RIPPLE_CONTAINER
        ), s.classList.add (this.CssClasses_.RIPPLE_EFFECT), s.classList.add (
          this.CssClasses_.RIPPLE_CENTER
        ), s.addEventListener ('mouseup', this.boundMouseUpHandler_);
        var i = document.createElement ('span');
        i.classList.add (this.CssClasses_.RIPPLE), s.appendChild (
          i
  ...
  var p = function (e) {
    (this.element_ = e), (this.isIE_ =
      window.navigator.msPointerEnabled), this.init ();
  };
  (window.MaterialSlider = p), (p.prototype.Constant_ = {}), (p.prototype.CssClasses_ = {
    ...
    0 === e
      ...
      : this.element_.classList.remove (this.CssClasses_.IS_LOWEST_VALUE), this
      .isIE_ ||
      ((this.backgroundLower_.style.flex = e), (this.backgroundLower_.style.webkitFlex = e), (this.backgroundUpper_.style.flex =
        1 - e), (this.backgroundUpper_.style.webkitFlex = 1 - e));
  }), (p.prototype.disable = function () {
    this.element_.disabled = !0;
  }), (p.prototype.disable =
    p.prototype.disable), (p.prototype.enable = function () {
    this.element_.disabled = !1;
  }), (p.prototype.enable =
    p.prototype.enable), (p.prototype.change = function (e) {
    'undefined' != typeof e &&
      (this.element_.value = e), this.updateValueStyles_ ();
  }), (p.prototype.change =
    p.prototype.change), (p.prototype.init = function () {
    if (this.element_) {
      if (this.isIE_) {
        var e = document.createElement ('div');
        e.classList.add (
        ...
        s.classList.add (this.CssClasses_.BACKGROUND_FLEX), t.appendChild (
          s
        ), (this.backgroundLower_ = document.createElement (
          'div'
        )), this.backgroundLower_.classList.add (
          this.CssClasses_.BACKGROUND_LOWER
        ), s.appendChild (
          this.backgroundLower_
        ), (this.backgroundUpper_ = document.createElement (
          'div'
        )), this.backgroundUpper_.classList.add (
          this.CssClasses_.BACKGROUND_UPPER
        ), s.appendChild (this.backgroundUpper_);
      }
      (this.boundInputHandler = this.onInput_.bind (
        this
      )), (this.boundChangeHandler = this.onChange_.bind (
        this
      )), (this.boundMouseUpHandler = this.onMouseUp_.bind (
        this
      ...
      ), this.updateValueStyles_ (), this.element_.classList.add (
        this.CssClasses_.IS_UPGRADED
      );
    }
  }), s.register ({
  ...
  var C = function (e) {
    if (
      ((this.element_ = e), (this.textElement_ = this.element_.querySelector (
    ...
    (this.active = !1), (this.actionHandler_ = void 0), (this.message_ = void 0), (this.actionText_ = void 0), (this.queuedNotifications_ = []), this.setActionHidden_ (
      !0
    );
  };
  (window.MaterialSnackbar = C), (C.prototype.Constant_ = {
    ...
    this.element_.setAttribute ('aria-hidden', 'true'), this.actionHandler_ &&
      ((this.actionElement_.textContent = this.actionText_), this.actionElement_.addEventListener (
        'click',
        this.actionHandler_
      ), this.setActionHidden_ (
        !1
      )), (this.textElement_.textContent = this.message_), this.element_.classList.add (
    ...
    this.active
      ...
      : ((this.active = !0), (this.message_ = e.message), e.timeout
          ? (this.timeout_ = e.timeout)
          : (this.timeout_ = 2750), e.actionHandler &&
          (this.actionHandler_ = e.actionHandler), e.actionText &&
          (this.actionText_ = e.actionText), this.displaySnackbar_ ());
  }), (C.prototype.showSnackbar =
    C.prototype.showSnackbar), (C.prototype.checkQueue_ = function () {
    this.queuedNotifications_.length > 0 &&
      this.showSnackbar (this.queuedNotifications_.shift ());
  }), (C.prototype.cleanup_ = function () {
    this.element_.classList.remove (this.cssClasses_.ACTIVE), setTimeout (
      function () {
        this.element_.setAttribute (
          'aria-hidden',
          'true'
        ), (this.textElement_.textContent = ''), Boolean (
          ...
          (this.setActionHidden_ (!0), (this.actionElement_.textContent =
            ...
            'click',
            this.actionHandler_
          )), (this.actionHandler_ = void 0), (this.message_ = void 0), (this.actionText_ = void 0), (this.active = !1), this.checkQueue_ ();
      }.bind (this),
  ...
  (window.MaterialSpinner = u), (u.prototype.Constant_ = {
    ...
    var t = document.createElement ('div');
    t.classList.add (this.CssClasses_.MDL_SPINNER_LAYER), t.classList.add (
    ...
    for (var a = [s, i, n], l = 0; l < a.length; l++) {
      ...
      o.classList.add (this.CssClasses_.MDL_SPINNER_CIRCLE), a[l].appendChild (
        o
      );
    }
    t.appendChild (s), t.appendChild (i), t.appendChild (
      n
    ), this.element_.appendChild (t);
  }), (u.prototype.createLayer =
    u.prototype.createLayer), (u.prototype.stop = function () {
  ...
  (window.MaterialSwitch = E), (E.prototype.Constant_ = {
    ...
    E.prototype.checkDisabled), (E.prototype.checkToggleState = function () {
    this.inputElement_.checked
      ? this.element_.classList.add (this.CssClasses_.IS_CHECKED)
      : this.element_.classList.remove (this.CssClasses_.IS_CHECKED);
  }), (E.prototype.checkToggleState =
    E.prototype.checkToggleState), (E.prototype.disable = function () {
    (this.inputElement_.disabled = !0), this.updateClasses_ ();
  }), (E.prototype.disable =
    E.prototype.disable), (E.prototype.enable = function () {
    (this.inputElement_.disabled = !1), this.updateClasses_ ();
    ...
    if (this.element_) {
      ...
      var s = document.createElement ('span');
      if (
        (s.classList.add (this.CssClasses_.FOCUS_HELPER), t.appendChild (
          s
        ), this.element_.appendChild (e), this.element_.appendChild (
          t
        ), (this.boundMouseUpHandler = this.onMouseUp_.bind (
          this
        )), this.element_.classList.contains (this.CssClasses_.RIPPLE_EFFECT))
      ...
      (this.boundChangeHandler = this.onChange_.bind (
        this
      )), (this.boundFocusHandler = this.onFocus_.bind (
        this
      )), (this.boundBlurHandler = this.onBlur_.bind (
        this
      )), this.inputElement_.addEventListener (
        'change',
        this.boundChangeHandler
  ...
  (window.MaterialTextfield = L), (L.prototype.Constant_ = {
    ...
    L.prototype.checkDisabled), (L.prototype.checkFocus = function () {
    Boolean (this.element_.querySelector (':focus'))
      ? this.element_.classList.add (this.CssClasses_.IS_FOCUSED)
      : this.element_.classList.remove (this.CssClasses_.IS_FOCUSED);
  }), (L.prototype.checkFocus =
    L.prototype.checkFocus), (L.prototype.checkValidity = function () {
    this.input_.validity &&
      (this.input_.validity.valid
        ? this.element_.classList.remove (this.CssClasses_.IS_INVALID)
        : this.element_.classList.add (this.CssClasses_.IS_INVALID));
  }), (L.prototype.checkValidity =
    L.prototype.checkValidity), (L.prototype.checkDirty = function () {
    this.input_.value && this.input_.value.length > 0
      ? this.element_.classList.add (this.CssClasses_.IS_DIRTY)
      : this.element_.classList.remove (this.CssClasses_.IS_DIRTY);
  }), (L.prototype.checkDirty =
    L.prototype.checkDirty), (L.prototype.disable = function () {
    (this.input_.disabled = !0), this.updateClasses_ ();
  }), (L.prototype.disable =
    L.prototype.disable), (L.prototype.enable = function () {
    (this.input_.disabled = !1), this.updateClasses_ ();
  }), (L.prototype.enable =
    L.prototype.enable), (L.prototype.change = function (e) {
    (this.input_.value = e || ''), this.updateClasses_ ();
  }), (L.prototype.change =
    L.prototype.change), (L.prototype.init = function () {
    if (
      this.element_ &&
      ...
      this.input_.hasAttribute (this.Constant_.MAX_ROWS_ATTRIBUTE) &&
        ((this.maxRows = parseInt (
          ...
          (this.maxRows = this.Constant_.NO_MAX_ROWS)), this.input_.hasAttribute (
        'placeholder'
      ) &&
        this.element_.classList.add (
        ...
        this
      )), (this.boundResetHandler = this.onReset_.bind (
        this
        ...
        'blur',
        this.boundBlurHandler
      ), this.input_.addEventListener ('reset', this.boundResetHandler), this
  ...
  (window.MaterialTooltip = I), (I.prototype.Constant_ = {}), (I.prototype.CssClasses_ = {
    ...
    this.element_.classList.contains (this.CssClasses_.LEFT) ||
      ...
      ? ((s = t.width / 2), 0 > i + a
          ...
          : ((this.element_.style.top =
              i + 'px'), (this.element_.style.marginTop = a + 'px')))
      : 0 > s + n
          ? ((this.element_.style.left = 0), (this.element_.style.marginLeft = 0))
          : ((this.element_.style.left =
              s + 'px'), (this.element_.style.marginLeft =
              n + 'px')), this.element_.classList.contains (
      ...
      : this.element_.classList.contains (this.CssClasses_.RIGHT)
          ...
          : this.element_.classList.contains (this.CssClasses_.LEFT)
              ...
              : (this.element_.style.top =
                  t.top + t.height + 10 + 'px'), this.element_.classList.add (
    ...
    if (this.element_) {
      ...
      e && (this.forElement_ = document.getElementById (e)), this.forElement_ &&
        (this.forElement_.hasAttribute ('tabindex') ||
          ...
          this
        )), (this.boundMouseLeaveHandler = this.handleMouseLeave_.bind (
          this
  ...
  (window.MaterialLayout = f), (f.prototype.Constant_ = {
    ...
    if (!this.header_.classList.contains (this.CssClasses_.IS_ANIMATING)) {
      ...
      this.content_.scrollTop > 0 &&
        ...
        ? (this.header_.classList.add (
          ...
          ), this.header_.classList.add (this.CssClasses_.IS_COMPACT), e &&
            this.header_.classList.add (this.CssClasses_.IS_ANIMATING))
        : this.content_.scrollTop <= 0 &&
            this.header_.classList.contains (this.CssClasses_.IS_COMPACT) &&
            (this.header_.classList.remove (
              this.CssClasses_.CASTING_SHADOW
            ), this.header_.classList.remove (this.CssClasses_.IS_COMPACT), e &&
              this.header_.classList.add (this.CssClasses_.IS_ANIMATING));
    }
    ...
    this.screenSizeMediaQuery_.matches
      ...
      : (this.element_.classList.remove (this.CssClasses_.IS_SMALL_SCREEN), this
          .drawer_ &&
    ...
    this.drawer_.classList.toggle (
      ...
      ? (this.drawer_.setAttribute ('aria-hidden', 'false'), e.setAttribute (
          'aria-expanded',
          'true'
        ))
      : (this.drawer_.setAttribute ('aria-hidden', 'true'), e.setAttribute (
          'aria-expanded',
          'false'
        ));
  }), (f.prototype.toggleDrawer =
    f.prototype.toggleDrawer), (f.prototype.init = function () {
    if (this.element_) {
      var e = document.createElement ('div');
      ...
      for (var i = this.element_.childNodes, n = i.length, a = 0; n > a; a++) {
        ...
        l.classList &&
          ...
          (this.header_ = l), l.classList &&
          l.classList.contains (this.CssClasses_.DRAWER) &&
          (this.drawer_ = l), l.classList &&
      ...
      window.addEventListener (
        ...
        function (e) {
          e.persisted &&
            ((this.element_.style.overflowY = 'hidden'), requestAnimationFrame (
              function () {
      ...
      if (
        (this.header_ &&
          (this.header_.classList.contains (this.CssClasses_.HEADER_SEAMED)
            ...
            : this.header_.classList.contains (
                ...
                ? ((o = this.Mode_.WATERFALL), this.header_.addEventListener (
                    'transitionend',
                ...
                : this.header_.classList.contains (
                    ...
                    ((o = this.Mode_.SCROLL), e.classList.add (
        ...
        if (!r) {
          (r = document.createElement ('div')), r.setAttribute (
            'aria-expanded',
            'false'
          ), r.setAttribute ('role', 'button'), r.setAttribute (
            'tabindex',
            '0'
        ...
        ), this.element_.appendChild (d), d.addEventListener (
          'click',
          this.drawerToggleHandler_.bind (this)
        ), (this.obfuscator_ = d), this.drawer_.addEventListener (
          'keydown',
      ...
      if (
        ...
        h.classList.add (
          this.CssClasses_.TAB_CONTAINER
        ), this.header_.insertBefore (
          h,
          this.tabBar_
        ), this.header_.removeChild (this.tabBar_);
        var c = document.createElement ('div');
        c.classList.add (this.CssClasses_.TAB_BAR_BUTTON), c.classList.add (
          this.CssClasses_.TAB_BAR_LEFT_BUTTON
        );
        var p = document.createElement ('i');
        p.classList.add (
          this.CssClasses_.ICON
        ), (p.textContent = this.Constant_.CHEVRON_LEFT), c.appendChild (
          p
        ), c.addEventListener (
          'click',
          function () {
        ...
        u.classList.add (
          this.CssClasses_.ICON
        ), (u.textContent = this.Constant_.CHEVRON_RIGHT), C.appendChild (
          u
        ), C.addEventListener (
          'click',
          function () {
        ...
        var E = function () {
          this.tabBar_.scrollLeft > 0
            ...
            : c.classList.remove (this.CssClasses_.IS_ACTIVE), this.tabBar_
            .scrollLeft <
        ...
        window.addEventListener ('resize', m), this.tabBar_.classList.contains (
          this.CssClasses_.JS_RIPPLE_EFFECT
  ...
  (window.MaterialDataTable = b), (b.prototype.Constant_ = {}), (b.prototype.CssClasses_ = {
              ...
              if (e.checked)
                for (t = 0; t < s.length; t++)
                  (i = s[t]
                    ...
                    .querySelector (
                      '.mdl-checkbox'
                    )), i.MaterialCheckbox.check (), s[t].classList.add (
                ...
                for (t = 0; t < s.length; t++)
                  (i = s[t]
                    ...
                    .querySelector (
                      '.mdl-checkbox'
                    )), i.MaterialCheckbox.uncheck (), s[t].classList.remove (
                    this.CssClasses_.IS_SELECTED
                  );
            }.bind (this)
          : void 0;
    ...
    return (a.type = 'checkbox'), a.classList.add ('mdl-checkbox__input'), e
  ...
  (window.MaterialRipple = y), (y.prototype.Constant_ = {
    ...
    if (!this.rippleElement_.style.width && !this.rippleElement_.style.height) {
      ...
      (this.boundHeight = t.height), (this.boundWidth =
        t.width), (this.rippleSize_ =
        2 * Math.sqrt (t.width * t.width + t.height * t.height) +
        2), (this.rippleElement_.style.width =
        this.rippleSize_ + 'px'), (this.rippleElement_.style.height =
        this.rippleSize_ + 'px');
    }
    if (
      (this.rippleElement_.classList.add (
      ...
      this.setRippleXY (i, n), this.setRippleStyles (
        !0
    ...
    if (this.element_) {
      ...
      this.element_.classList.contains (
        ...
        ((this.rippleElement_ = this.element_.querySelector (
          '.' + this.CssClasses_.RIPPLE
        )), (this.frameCount_ = 0), (this.rippleSize_ = 0), (this.x_ = 0), (this.y_ = 0), (this.ignoringMouseDown_ = !1), (this.boundDownHandler = this.downHandler_.bind (
          this
        )), this.element_.addEventListener (
          'mousedown',
          ...
          'touchstart',
          this.boundDownHandler
        ), (this.boundUpHandler = this.upHandler_.bind (
          this
        )), this.element_.addEventListener (
          'mouseup',
          this.boundUpHandler
          ...
          if (null !== this.rippleElement_) {
            ...
            t
              ? ((i = this.Constant_.INITIAL_SCALE), (n = this.Constant_
                  .INITIAL_SIZE))
              : ((i = this.Constant_.FINAL_SCALE), (n =
                  this.rippleSize_ + 'px'), e &&
                  (a =
                    'translate(' +
                    this.boundWidth / 2 +
                    'px, ' +
              ...
              'translate(-50%, -50%) ' +
              a +
              i), (this.rippleElement_.style.webkitTransform = s), (this.rippleElement_.style.msTransform = s), (this.rippleElement_.style.transform = s), t
